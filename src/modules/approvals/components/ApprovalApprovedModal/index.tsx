    ...
    >
      <StyledDiv>
        <Typography as="p" className="approve-registration-content">
          {`Are you sure you want to approve registration ${selectedApprovalData?.registration_id} for ${selectedApprovalData?.user?.full_name || ""}? This action will make the data visible in the dashboard.`}
        </Typography>
